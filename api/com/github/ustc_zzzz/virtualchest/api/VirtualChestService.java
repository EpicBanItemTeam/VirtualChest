...
/**
 * Representation of a provider for chest GUIs. The implementation may not be thread safe.
 * <p>
...
public interface VirtualChestService
{
     ...
     * @param player     the player
     * @return true if the chest GUI is available and not opened, false otherwise
     */
     ...
     * @param identifier the id for the chest GUI to be opened
     * @param player     the player
     * @return true if the chest GUI is available and opened, false otherwise
     */
